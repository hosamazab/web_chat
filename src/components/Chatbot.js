...
export default function Chatbot() {
  ...
  const sendMessage = async (text, speaker) => {
    ...
    // url for our server : http://91.108.80.252:10036
    try {
      if (speaker === "user") {
        setMessages((prev) => [...prev, { text, sender: speaker }]);
        const response = await fetch(`http://91.108.80.252:10036/ttt/?text=${encodeURIComponent(text)}&id=${encodeURIComponent(userId)}`);
  ...
  return (
    <div style={{
      ...
      <div
        className="div1">
        <img draggable="false" src="https://bbi.ai/wp-content/uploads/2022/10/shutterstock_678225592-scaled.webp" style={{
          height: "50vh",
          width: "100%",
          objectFit: "cover",
        }} >
        ...
        <div style={{
          ...
          left: "10px",
          objectFit: "cover"
        }}><img draggable="false" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTlqN_jw9ukJmRwAtfGef332AMKAueF1O60tA&s" style={{
          height: "80px",
          top: "0",
          left: "0",
          objectFit: "cover",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p className="para"><h3> YOUR TRUSTED PARTNER IN DATA & AI SOLUTIONS</h3>
            Founded in 2009, BBI has established a strong presence across Egypt, the UAE, KSA, and Algeria.

            With a team of 250+ skilled professionals, we have successfully delivered 500+ projects across multiple industries, helping businesses harness the power of data.

            At BBI, we empower organizations to unlock the full potential of their data, transforming it into actionable insights and strategic assets for sustainable growth. </p>
        </div>
        <div style={{
          objectFit: "cover",
          position: "relative",
          ...
          <p className="para"> grounded in innovation and
            partnerships is to provide end-to-end data and
            Al solutions starting by the definition of an
            actionable and customized data and Al strategy
            followed by its effective implementation by BBI's
            experienced professionals, powered by
            sustainable and ethical Al. </p>
        </div>
        <div style={{
          position: "relative",
          bottom: "0",
          ...
          <footer style={{ position: "relative", width: "100%", backgroundColor: "#f0f0f0", textAlign: "center", padding: "20px", marginTop: "40px" }}>
            <div>
              <div style={{ color: "blue", fontSize: "18px", fontWeight: "bold" }}>Address : <a style={{ fontWeight: "lighter", color: "blue", textDecoration: "none" }} href="https://maps.app.goo.gl/FjJKBuczk3vfz43s7">BBI</a></div>
              <div style={{ color: "blue", fontSize: "18px", fontWeight: "bold" }}>Phone : <a style={{ fontWeight: "lighter", color: "blue", textDecoration: "none" }} href="tel:+20223505299">+20 2 2350 5299</a></div>
              <div style={{ color: "blue", fontSize: "18px", fontWeight: "bold" }}>Email : <a href="mailto:info@bbi.ai" style={{ fontWeight: "lighter", color: "blue", textDecoration: "none" }}>
                info@bbi.ai
              </a></div>
            </div>
          </footer>
